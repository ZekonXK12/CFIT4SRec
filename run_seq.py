...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model', '-m', type=str, default='Mamba4Rec', help='name of models')
    ...
    # parser.add_argument('--dataset', '-d', type=str, default='Amazon_All_Beauty', help='name of datasets')
    # parser.add_argument('--dataset', '-d', type=str, default='Amazon_Fashion', help='name of datasets')
    # parser.add_argument('--dataset', '-d', type=str, default='Amazon_Sports_and_Outdoors', help='name of datasets')
    # parser.add_argument('--dataset', '-d', type=str, default='Amazon_Movies_and_TV', help='name of datasets')
    # parser.add_argument('--dataset', '-d', type=str, default='ml-1m', help='name of datasets')
